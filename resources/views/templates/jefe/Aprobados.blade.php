...
<body>
	...
	<div class="container">
		@if (Session::has('flash_message'))
  		...
  		<h2>Alumnos Aprobados en el Proyecto de {{$dato->nombre}}</h2>
	...
	<div class="text-center w-full" style="margin-top: 50px">
		...
		<a href="<?php echo route('aprobadosJ') ?>" class="btn btn-info"> Regresar a proyectos </a>
	</div>
