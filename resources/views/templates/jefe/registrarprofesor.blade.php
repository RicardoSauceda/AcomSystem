    ...
    <div class="limiter">
        ...
        <div class="container-login100" style="background-image: url('plogin/images/img-01.jpg');">
            <div class="wrap-login100 p-t-80 p-b-5">
                ...
                <form action="/registrarProfesor" method="POST" class="login100-form validate-form" id="contactForm">
                    {{ csrf_field() }}
                    ...
                    <div class="wrap-input100 validate-input m-b-10"
                        data-validate="El Nombre del profesor es requerido">
                        <input value="{{ old('nombre') }}" required="" class="input100" type="text" name="nombre"
                            placeholder="Nombre-profesor" id="nombre">
                    ...
                    <div class="wrap-input100 validate-input m-b-10" data-validate="Departamento is required">
                        ...
                        <select required="" name="departamento" id="inputCategoria_id" class="input100">
                            ...
                            <option value="DepartamentodeGestionEmpresarial">Departamento de Gestion Empresarial
                            </option>
                            ...
                            <option value="DepartamentodeGestionTecnologica">Departamento de Gestion Tecnologica
                            </option>
                            <option value="DepartamentodeDesarrolloAcademico">Departamento de Desarrollo Academico
                            </option>
                    ...
                    <div class="wrap-input100 validate-input m-b-10" data-validate="Usuario es requerido">
                        <input value="{{ old('usuario') }}" required="" class="input100" type="text"
                            name="usuario" placeholder="Usuario" id="usuario">
                        <span class="focus-input100"></span>
                        <span class="symbol-input100">
                            <i class="fa fa-user"></i>
                        </span>
                    ...
                    <div class="wrap-input100 validate-input m-b-10" data-validate="Contraseña es requerido">
                        <input class="input100" type="password" required="" name="password"
                            placeholder="Contraseña" id="passwd">
                        <span class="focus-input100"></span>
                        <span class="symbol-input100">
