  		...
  		<table class="table table-striped table-bordered table-hover table-condensed">
		    ...
		    <tbody>
		    	<tr>
					...
					<td>
						<a href="{{ route ('aprorepro', [$proyecto->codigo, $proyecto->tipo, $proyecto->nombre])}}" >Proyecto de {{ $proyecto->nombre}}</a>
					</td>

					<td>
						<a href="{{ route ('barSolicitudes', [$proyecto->codigo, $proyecto->nombre])}}">Proyecto de {{$proyecto->nombre}}</a>
					</td>
		    	</tr>
