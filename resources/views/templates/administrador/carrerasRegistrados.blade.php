...
<body>
 ...
 -->
		{{ Form::close() }}
		    ...
		    <tbody>
		      <tr>
		        ...
		        <td>
						...
						<a href="{{route('changeCarre',[$profesor->idCar]) }}"><div style="display: flex; justify-content: center;"><img style=" width: 35px; height: 35px;" src="plogin/images/icons/cambiarJefe.png"></div></a> 
				</td>
				<td>
					<a href="{{route('changeNombreCarre',[$profesor->idCar]) }}"><div style="display: flex; justify-content: center;"><img style=" width: 35px; height: 35px;" src="plogin/images/icons/editar.png"></div></a>
		  ...
		  {{ $depar->appends(Request::all())->render() }}
