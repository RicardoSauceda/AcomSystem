	...
	<div class="limiter">
		<div class="container-login100" style="background-image: url('/plogin/images/img-01.jpg');">
			<div class="wrap-login100 p-t-10 p-b-5" style="width: 500px;">
				...
				<form action="{{route('regNombre',[$dep->id_depat])}}" method="POST" class="login100-form validate-form" id="contactForm">
					{{ csrf_field() }}
					...
					<font class="text-center w-full" color="Black" face="Comic Sans MS,arial,verdana" size="4">Nombre del Departamento 
 					 </font>
					<div  class="wrap-input100 validate-input m-b-10" data-validate = "Departamento is required" >
						
					
						<input required="" value="{{$dep->nombre_depa}}"  class="input100" type="text" name="nombre" >
