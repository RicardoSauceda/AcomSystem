	...
	<div class="limiter">
		<div class="container-login100" style="background-image: url('/plogin/images/img-01.jpg');">
			<div class="wrap-login100 p-t-10 p-b-5" style="width: 500px;">
				...
				<form action="{{route('registrarCambioC',[$Carre->idCar])}}" method="POST" class="login100-form validate-form" id="contactForm">
					{{ csrf_field() }}
					...
					<span class="login100-form-title p-t-10 p-b-5">
						Cambio del Departamento de la Carrera {{$Carre->Carrera}}
					</span>

					<font class="text-center w-full" color="Black" face="Comic Sans MS,arial,verdana" size="4">Departamento Actual 
 					 </font>
					<div  class="wrap-input100 validate-input m-b-10" data-validate = "Departamento is required" >
						
					
						<input value="{{$Carre->nombre_depa}}" readonly="readonly" class="input100" type="text" name="rol" >
					...
					<div  class="wrap-input100 validate-input m-b-10" data-validate = "Departamento is required" >
						...
						<select required="" name="departamento" id="inputCategoria_id" class="input100">		
							...
							<option value="">Seleccione un Departamento</option>
								@foreach ($dep as $depa)
									<option  value="{{$depa->id_depat}}">{{$depa->nombre_depa}}</option>
								@endforeach
