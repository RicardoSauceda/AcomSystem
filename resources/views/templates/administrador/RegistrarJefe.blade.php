			...
			<div class="wrap-login100 p-t-10 p-b-5">
				...
				<form action="/registrar" method="POST" class="login100-form validate-form" id="contactForm">
					...
					<div class="wrap-input100 validate-input m-b-10" data-validate = "Nombre es requerido">
						<input value="{{ old('nombre') }}" required="" class="input100" type="text" name="nombre" placeholder="Nombre del Jefe" id="nombre">
					...
					<div name="categoria" class="wrap-input100 validate-input m-b-10" data-validate = "TipoCargo is required">
					...
					<div class="wrap-input100 validate-input m-b-10" data-validate = "Usuario es Requerido">
						<input value="{{ old('usuario') }}" required="" class="input100" type="text" name="usuario" placeholder="Username" id="usuario">
						<span class="focus-input100"></span>
						<span class="symbol-input100">
							<i class="fa fa-user"></i>
						</span>
					...
					<div class="wrap-input100 validate-input m-b-10" data-validate = "Contraseña es Requerida">
						<input class="input100" type="password" required="" name="password" placeholder="Password" id="passwd">
						<span class="focus-input100"></span>
						<span class="symbol-input100">
