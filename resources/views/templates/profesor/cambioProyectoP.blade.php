			...
			<div class="wrap-login100 p-t-40 p-b-5">
				...
				<form action="/guardar" method="POST" class="login100-form validate-form" id="contactForm">
					...
					<div class="wrap-input100 validate-input m-b-10" data-validate = "Nombre de Actividad es requerido">
						<input value="{{old('nombre')}}" required="" class="input100" type="text" name="nombre" placeholder="Nombre-Actividad" id="proyecto">
					...
					<div class="wrap-input100 validate-input m-b-10" data-validate = "Nombre del rol es requerido">
						<input value="{{old('rol')}}" required="" class="input100" type="text" name="rol" placeholder="Nombre-Rol-Encargado" id="rolEncargado">
						<span class="focus-input100"></span>
						<span class="symbol-input100">
							<i class="fa fa-user"></i>
						</span>
					...
					<font class="text-center w-full" color="Black" face="Comic Sans MS,arial,verdana" size="4">Cantidad de Alumnos
 					 </font>
					...
					<font class="text-center w-full" color="Black" face="Comic Sans MS,arial,verdana" size="4">Codigo de la actividad
 					 </font>
					<div class="wrap-input100 validate-input m-b-10" data-validate = "Codigo de la Actividad Requerida">
						<input required="" class="input100" type="integer" name="codigo" placeholder="Codigo de la Actividad" id="codigo">
						<span class="focus-input100"></span>
						<span class="symbol-input100">
							<i class=""></i>
						</span>
					...
					<textarea required=""  name="descrip" rows="10" cols="45" placeholder="Descripción de la actividad para que el alumno sepa de que trata" style="border-radius: 15px; padding: 5px;"></textarea>
