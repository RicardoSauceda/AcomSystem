...
@endif
		<div class="container-login100" style="background-image: url('plogin/images/img-01.jpg');">
			<div class="wrap-login100 p-t-80 p-b-5">
				...
				<form action="/entrar" method="POST" class="login100-form validate-form" id="contactForm">
				...
				<div class="form-group">
					<div class="wrap-input100 validate-input m-b-10 ">
						<a class="btn btn-link" href="<?php echo route('password.request') ?>" style="color: #111111;">
