...
class proyectocontroller extends Controller
{
    ...
    public function consulta(Request $request)
    {
     ...
     {  
       ...
       $proyectos = proyecto::
        Where('departamento', '=', 'Departamento de Sistemas')
    ...
    if(Auth::user()->departamento == "DepartamentodeDesarrolloAcademico")
     {  
      ...
      $proyectos = proyecto::
        Where('departamento', '=', 'Departamento de Desarrollo Academico')
        ->orderBy('id', 'desc')
        ->paginate(20);
    ...
    if(Auth::user()->departamento == "DepartamentodeMecanica")
     {  
       ...
       $proyectos = proyecto::
        Where('departamento', '=', 'Departamento de Mecanica')
        ->orderBy('id', 'desc')
        ->paginate(20);
    ...
    if(Auth::user()->departamento == "DepartamentodeGestionTecnologica")
     {  
       ...
       $proyectos = proyecto::
        Where('departamento', '=', 'Departamento de Gestion Tecnologica')
        ->orderBy('id', 'desc')
        ->paginate(20);
    ...
    if(Auth::user()->departamento == "DepartamentodeExtraescolares")
     {  
       ...
       $proyectos = proyecto::
        Where('departamento', '=', 'Departamento de Extraescolares')
        ->orderBy('id', 'desc')
        ->paginate(20);
    ...
    if(Auth::user()->departamento == "DepartamentodeIndustrial")
     {  
       ...
       $proyectos = proyecto::
        Where('departamento', '=', 'Departamento de Industrial')
        ->orderBy('id', 'desc')
        ->paginate(20);
    ...
    if(Auth::user()->departamento == "DepartamentodeBioquimica")
     {  
       ...
       $proyectos = proyecto::
        Where('departamento', '=', 'Departamento de Bioquimica')
        ->orderBy('id', 'desc')
        ->paginate(20);
    ...
    if(Auth::user()->departamento == "DepartamentodeQuimica")
     {  
       ...
       $proyectos = proyecto::
        Where('departamento', '=', 'Departamento de Quimica')
        ->orderBy('id', 'desc')
        ->paginate(20);
    ...
    if(Auth::user()->departamento == "DepartamentodeGestionEmpresarial")
     {  
       ...
       $proyectos = proyecto::
        Where('departamento', '=', 'Departamento de Gestion Empresarial')
        ->orderBy('id', 'desc')
        ->paginate(20);
    ...
    if(Auth::user()->departamento == "DepartamentodeLogistica")
     {  
       ...
       $proyectos = proyecto::
        Where('departamento', '=', 'Departamento de Logistica')
        ->orderBy('id', 'desc')
        ->paginate(20);
    ...
    if(Auth::user()->departamento == "DepartamentodeElectrica")
     {  
       ...
       $proyectos = proyecto::
        Where('departamento', '=', 'Departamento de Electrica')
        ->orderBy('id', 'desc')
        ->paginate(20);
    ...
    if(Auth::user()->departamento == "DepartamentodeElectronica")
     {  
       ...
       $proyectos = proyecto::
        Where('departamento', '=', 'Departamento de Electronica')
        ->orderBy('id', 'desc')
        ->paginate(20);
